...
const Navbar = () => {
  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-sm' : 'bg-white'}`}>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-slate-950">ShopEase</span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/login" className="bg-purple hover:bg-purple-dark text-white px-4 py-2 rounded-md transition-colors duration-300">
              Login
            </Link>
          </div>
        </div>
